...
import com.app.mybook.ui.BookInfoActivity;
import com.app.mybook.ui.CaptureActivity;
import com.app.mybook.ui.MainActivity;
  ...
  public void handleMessage(Message message) {
    switch (message.what) {
      ...
      case R.id.decode_succeeded:
		...
		intent.putExtra("isbn", str_result);
		intent.putExtra("isIsbn",true);
